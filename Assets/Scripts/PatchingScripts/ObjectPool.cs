		...
		if (instance.pooledObjects.TryGetValue(prefab, out list))
		{
			...
			if (list.Count > 0)
			{
				...
				if (obj != null)
				{
					...
					//LogManager.Log("Active .....................",LogManager.LogType.GENERAL);
			...
			trans.localRotation = rotation;
			instance.spawnedObjects.Add(obj, prefab);
			//LogManager.Log("Instaniate Count 0 .....................",LogManager.LogType.GENERAL);

			return obj;
		}
		else
		{
			//LogManager.Log("Instantia .....................",LogManager.LogType.GENERAL);
			obj = (GameObject)Object.Instantiate(prefab);
